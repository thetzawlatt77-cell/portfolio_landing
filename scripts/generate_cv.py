...
story = [
    ...
    *section("CORE EXPERTISE"),
    Paragraph("<b><font color='#173B4C'>Mobile Engineering:</font></b> Flutter, Dart, iOS/Android delivery, responsive mobile UI, Firebase, REST APIs, WebSockets, Platform Channels", compact_style),
    ...
    *experience(
        ...
        "eTrade Myanmar",
        [
            "Built movie-streaming features and integrated an Android-native video player into Flutter through Platform Channels.",
            "Delivered complex Figma-based UI and API-driven state using GetX/Provider.",
    ...
    *experience(
        ...
        [
            "Built a Microsoft Authenticator-style mobile app with two-factor authentication and fingerprint-based verification.",
            "Implemented WebSocket-powered real-time sign-in alerts, allowing users to review and approve authentication requests in the app.",
            "Delivered production Flutter UI and feature workflows across enterprise ERP and education products.",

...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    focusAreas: ["Movie Streaming", "Native Android Player", "Platform Channels"],
    bullets: [
      "Built movie-streaming features and integrated an Android-native video player into Flutter through Platform Channels.",
      "Implemented complex Figma-based UI and playback-facing mobile workflows.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Implemented WebSocket-powered real-time sign-in alerts so users could review and approve authentication requests in the app.",
      "Delivered production Flutter UI and feature workflows across office ERP and education products.",
